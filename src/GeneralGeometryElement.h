 ...
 * @brief A class representing a general geometric element with normal and centroid calculations.
 * 
 * This class provides functionality to manage and manipulate geometric elements,
 * including methods for calculating normals and centroids, and flipping the orientation of the normal if needed.
 */
class GeneralGeometryElement {
protected:
...
public:
     ...
     * 
     * If the dot product between the provided normal and the reference normal is negative,
     * the normal vector is flipped.
     * 
