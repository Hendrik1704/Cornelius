...
void GeneralGeometryElement::flip_normal_if_needed(std::array<double, DIM> &normal, std::array<double, DIM> &reference_normal) {
    // Compute the dot product of the two normals
    double dot_product = std::inner_product(normal.begin(), normal.end(), reference_normal.begin(), 0.0);
...
std::array<double, GeneralGeometryElement::DIM> GeneralGeometryElement::get_normal() {
...
std::array<double, GeneralGeometryElement::DIM> GeneralGeometryElement::get_centroid() {
