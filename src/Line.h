...
/**
 * @class Line
 * @brief Represents a line in a geometric space, derived from GeneralGeometryElement.
 *
 * The Line class encapsulates the properties and operations related to a line segment in 
 * a geometric space. It provides methods to initialize the line, flip its start and end points,
 * and calculate various geometric properties such as the normal and centroid.
 */
...
protected:
    ...
    std::array<std::array<double, DIM>, LINE_DIM> corners; ///< Array of line corners
    std::array<double, DIM> out; ///< Output point of the line
    std::array<double, DIM-LINE_DIM> const_i; ///< Constant indices for the line
...
public:
    ...
    /**
     * @brief Initializes the line with specific corner points, an output point, and constant indices.
     *
     ...
     *
     * This method swaps the line's start and end points to reverse the direction of the line.
     */
    void flip_start_end();
